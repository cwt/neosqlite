...
def test_unwind_group_optimization_pattern_2():
    ...
    with Connection(":memory:") as conn:
        ...
        collection.insert_many([
            ...
            {"name": "Bob", "department": "Engineering", "skills": ["java", "python"]},
            {"name": "Charlie", "department": "Marketing", "skills": ["design", "sql"]},
            {"name": "David", "department": "Engineering", "skills": ["python", "javascript"]}
        ])
...
def test_unwind_with_text_search_optimization():
    ...
    with Connection(":memory:") as conn:
        ...
        collection.insert_many([
            {"name": "Alice", "keywords": ["python", "machine learning", "data science"]},
            {"name": "Bob", "keywords": ["java", "spring", "microservices"]},
            {"name": "Charlie", "keywords": ["python", "django", "web development"]}
        ])
...
def test_complex_unwind_group_patterns():
    ...
    with Connection(":memory:") as conn:
        ...
        assert len(teams_data["A"]["uniqueScores"]) >= 1  # At least some unique scores
...
def test_unwind_group_edge_cases():
    ...
    with Connection(":memory:") as conn:
        ...
        collection.insert_many([
            ...
            {"id": 3, "tags": ["multiple", "tags", "here"]},  # Multiple elements
