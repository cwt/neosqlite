...
class BaseSqlMixin:
    ...
    def _convert_array_transform_operator(self, operator: str, operands: Any) -> tuple[str, list[Any]]: ...  # type: ignore[empty-body]
    ...
    def _convert_date_from_parts_operator(self, operands: Any) -> tuple[str, list[Any]]: ...  # type: ignore[empty-body]
    def _convert_date_to_parts_operator(self, operands: Any) -> tuple[str, list[Any]]: ...  # type: ignore[empty-body]
    def _convert_date_from_string_operator(self, operands: Any) -> tuple[str, list[Any]]: ...  # type: ignore[empty-body]
