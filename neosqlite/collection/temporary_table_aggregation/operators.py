...
class OperatorsMixin:
    # Type annotations for attributes supplied by
    # TemporaryTableAggregationProcessor.__init__. Declared here (mixin-only)
    # so static analysis knows they exist; values are assigned by the subclass.
    collection: Any
    db: Any
    query_engine: Any
    expr_evaluator: Any
