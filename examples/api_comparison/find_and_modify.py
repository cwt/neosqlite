...
def compare_find_and_modify():
    ...
    with neosqlite.Connection(":memory:") as neo_conn:
        ...
        # Test find_one_and_delete - ONLY time if MongoDB is available
        if mongo_available:
            start_neo_timing()
        try:
        ...
        # Test find_one_and_replace - ONLY time if MongoDB is available
        if mongo_available:
            start_neo_timing()
        try:
        ...
        # Test find_one_and_update - ONLY time if MongoDB is available
        if mongo_available:
            start_neo_timing()
        try:
