...
def compare_crud_operations():
    ...
    reporter.record_comparison("CRUD", "insert_one", "OK", "OK")
    reporter.record_comparison("CRUD", "insert_many", "OK", "OK")
    reporter.record_comparison("CRUD", "find", "OK", "OK")
    reporter.record_comparison("CRUD", "find_one", "OK", "OK")
    reporter.record_comparison("CRUD", "update_one", "OK", "OK")
    reporter.record_comparison("CRUD", "update_many", "OK", "OK")
    reporter.record_comparison("CRUD", "replace_one", "OK", "OK")
    reporter.record_comparison("CRUD", "delete_one", "OK", "OK")
    reporter.record_comparison("CRUD", "delete_many", "OK", "OK")
    reporter.record_comparison("CRUD", "count_documents", "OK", "OK")
    reporter.record_comparison("CRUD", "estimated_document_count", "OK", "OK")
