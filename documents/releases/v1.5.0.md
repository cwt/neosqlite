...
**Key Achievement**: NeoSQLite now supports more mathematical operators than MongoDB, including native hyperbolic functions and sigmoid activation—making it ideal for scientific computing and machine learning workloads.
...
- **`$log2`** - Base-2 logarithm - **NeoSQLite extension** ⚠️
...
# ⚠️ UserWarning: $log2 is a NeoSQLite extension (not available in MongoDB).
...
|----------|-------------|----------|--------|
| Comparison | 7/7 | 100% | ✅ Complete |
| Logical | 4/4 | 100% | ✅ Complete |
| Arithmetic | 17/17 | 100% | ✅ Complete |
| Conditional | 3/3 | 100% | ✅ Complete |
| Array | 15/15 | 100% | ✅ Complete |
| String | 18/18 | 100% | ✅ Complete |
| Date/Time | 15/20 | 75% | ⚠️ 5 missing |
| Object | 5/5 | 100% | ✅ Complete |
| Type Conversion | 11/11 | 100% | ✅ Complete |
| Trigonometric | 13/13 | 100% | ✅ Complete |
| Hyperbolic | 6/6 | 100% | ✅ Complete |
| Exponential/Sigmoid | 2/2 | 100% | ✅ Complete |
| Other | 1/2 | 50% | ⚠️ 1 missing |
| **Total** | **119/120** | **99%** | **🎯 Near Complete** |
...
**Updated Files:**
- **`documents/EXPR_IMPLEMENTATION.md`** - Updated operator counts (106 → 119), added hyperbolic and sigmoid documentation
...
2. Easy migration: `{ $log2: <x> }` → `{ $log: [ <x>, 2 ] }`
